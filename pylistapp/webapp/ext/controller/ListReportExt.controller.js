sap.ui.define([
    ...
    return {
        getCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                var oCustomField1 = this.oView.byId("CPGuidID");
                if (oCustomField1) {
                    oCustomData.CPGuid = oCustomField1.getSelectedKey();
                }
            }
        },
        restoreCustomAppStateDataExtension: function (oCustomData) {
            ...
            if (oCustomData) {
                if (oCustomData.CPGuid) {
                    var oComboBox = this.oView.byId("CPGuidID");
        ...
        onBeforeRebindTableExtension: function(oEvent) {
            ...
            if (oSmartFilterBar instanceof SmartFilterBar) {
                var oCustomControl = oSmartFilterBar.getControlByKey("CPGuid");
