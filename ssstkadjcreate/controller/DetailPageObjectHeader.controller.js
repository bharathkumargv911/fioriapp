sap.ui.define([
	...
	var product = "PD";
	return Controller.extend("com.arteria.ss.stockadjustmnt.create.controller.DetailPageObjectHeader", {

		/**
		 * Called when a controller is instantiated and its View controls (if available) are already created.
		 * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
		 * @memberOf com.arteria.ss.stockadjustmnt.create.view.DetailPageObjectHeader
		 */
		onInit: function() {
			this.onInitHookUp();
		},
